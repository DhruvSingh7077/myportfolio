    ...
    <section 
       ...
       className='py-24 pb-24 px-[12vw] md:px-[7vw] lg:px-[16vw] font-sans bg-skills-gradient clip-path-custom-3'>
         ...
         <div className='text-center mb-16'>
           ...
           <p className='text-gray-400 mt-4 text-lg font-semibold'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit, dignissimos.</p>
         </div>
         {/* Education Timeline*/}
         <div className='relative'>
           {/* Vertical Line*/}
            ...
            ${index % 2 === 0 ? "sm:ml-0  sm:mr-44" : "sm:ml-44 sm:mr-0"} ml-8 transform transition-transform duration-300 hover:scale-105`}>
   
                     {/* Flex container for image and text */}
                     <div className="flex items-center space-x-6">
                       {/* school logo */}
                       <div className="w-16 h-16 bg-white rounded-md overflow-hidden">
                         <img className="w-full h-full object-cover" src={edu.img} alt={edu.company} />
                       </div>
