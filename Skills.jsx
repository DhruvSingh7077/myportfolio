...
const Skills = () => (
  ...
  <section
    id="skills"
    className=" relative py-24 pb-24 px-[12vw] md:px-[7vw] lg:px-[20vw] font-sans bg-skills-gradient "
  >
    {/* Section Title */}
 ...
 {/* 🔽 Curved SVG Transition at Bottom */}
    <div className="w-full overflow-hidden leading-[0] -mt-1">
      ...
      >
        <path
          ...
          fill="#050414" // Match background of next section
        />
      </svg>
    </div>
